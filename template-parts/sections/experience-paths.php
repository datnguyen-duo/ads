    ...
    <div class="<?php echo $layout . '__paths'; ?>">
        <?php foreach ($paths as $path): 
            ...
            <div class="<?php echo $layout . '__path'; ?>">
                ...
                <?php endif; ?>
                <?php if ($cta): ?>
                    <a href="<?php echo $cta['url']; ?>" class="<?php echo $layout . '__path-cta button__text'; ?>"><?php echo $cta['title']; ?></a>
                <?php endif; ?>
            </div>
        <?php endforeach; ?>
        <svg class="<?php echo $layout . '__line'; ?>" width="844" height="1328" viewBox="0 0 844 1328" fill="none" xmlns="http://www.w3.org/2000/svg">
