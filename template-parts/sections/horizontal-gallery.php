...
<div class="<?php echo $layout . '__container swiper'; ?>">
    ...
    <div class="<?php echo $layout . '__navigation swiper-buttons'; ?>">
        <button class="<?php echo $layout . '__navigation-button swiper-button-prev button__icon'; ?>">
            <img class="<?php echo $layout . '__navigation-button-icon-image button__icon-image'; ?>" src="<?php echo get_template_directory_uri(); ?>/assets/icons/arrow.svg" alt="Previous Image" loading="lazy">
        </button>
        <button class="<?php echo $layout . '__navigation-button swiper-button-next button__icon'; ?>">
            <img class="<?php echo $layout . '__navigation-button-icon-image button__icon-image'; ?>" src="<?php echo get_template_directory_uri(); ?>/assets/icons/arrow.svg" alt="Next Image" loading="lazy">
        </button>
    </div>
</div>