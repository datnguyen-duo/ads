...
function load_more_posts() {
    ...
    $posts_per_page = isset($_POST['posts_per_page']) ? intval($_POST['posts_per_page']) : 1; // For testing
    ...
    $args = array(
        ...
        'paged' => $paged, // Use WordPress's built-in pagination
        'post_status' => 'publish',
    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            // Always use the default content-card template
            get_template_part('template-parts/content/content', 'card');
        }
    }
    
    // Calculate if there are more posts accurately
